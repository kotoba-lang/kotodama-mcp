...
import { findTool, tools, type HuggingfaceHandle } from "./tools.js";
...
export function createYorishiroHuggingfaceMcpServer(config: McpServerConfig): Server {
  const server = new Server(
    {
      name: config.name ?? "etzhayyim-yorishiro-huggingface",
