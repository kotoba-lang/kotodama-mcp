...
server.tool("visualize_pharma_supply_chain", "Generate a visualization (Mermaid) of the end-to-end supply chain spanning from expired patent candidate, procurement, robotics manufacturing, and distribution.", VizSchema.shape, async ({ productId, includeRobotics }) => {
...
server.tool("start_generic_manufacturing_candidate", "Trigger the pipeline to create a generic manufacturing candidate from an expired pharmaceutical patent.", {
