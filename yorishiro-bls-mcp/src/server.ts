...
import { findTool, tools, type BlsHandle } from "./tools.js";
...
export function createYorishiroBlsMcpServer(config: McpServerConfig): Server {
  const server = new Server(
    {
      name: config.name ?? "etzhayyim-yorishiro-bls",
